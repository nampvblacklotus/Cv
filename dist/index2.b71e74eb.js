...
const users = new (0, _collection.Collection)(`http://localhost:3000/users/${id}`, (json)=>{
...
(0, _axiosDefault.default).get("http://localhost:3000/users/").then((res)=>{
...
},{"./models/Collection":"dD11O","./models/User":"4rcHn","./views/UserForm":"gXSLD","./views/UserEdit":"3CihC","axios":"jo6P5","./views/UserList":"mUs49","./views/UserShow":"2Tlyi","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dD11O":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
class UserForm extends (0, _view.View) {
    ...
    constructor(...args){
        ...
        this.onAddClick = ()=>{
            ...
            const inputAge = document.getElementById("input2");
            const inputEmail = document.getElementById("input3");
            const inputPhone = document.getElementById("input4");
        ...
        this.onDelClick = ()=>{
            ...
            if (element) {
                ...
                if (idString) {
                    ...
                    (0, _axiosDefault.default).delete(`http://localhost:3000/users/${id}`).then((res)=>{
                        console.log("Phần tử đ\xe3 được x\xf3a từ server");
                        const user = res.data;
                        console.log(res.data);
                        window.location.reload();
                    // Tiếp theo, bạn có thể thực hiện các hành động bổ sung sau khi xóa phần tử thành công từ server.
                    }).catch((error)=>{
                        console.log("Lỗi x\xf3a phần tử từ server:", error);
                    });
                }
            }
        };
...
},{"./View":"5Vo78","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../models/User":"4rcHn","axios":"jo6P5"}],"5Vo78":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./View":"5Vo78","./UserForm":"gXSLD","./UserShow":"2Tlyi","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2Tlyi":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
//# sourceMappingURL=index2.b71e74eb.js.map
