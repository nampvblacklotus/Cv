...
var _userShow = require("./views/UserShow");
...
users.on("change", ()=>{
    ...
    if (root) {
        ...
        new (0, _userShow.UserShow)(root, user).render();
    }
});

},{"./views/UserList":"mUs49","./models/Collection":"dD11O","./models/User":"4rcHn","./views/UserForm":"gXSLD","./views/UserEdit":"3CihC","./views/UserShow":"2Tlyi"}],"mUs49":[function(require,module,exports) {
...
<body>
    ...
    <div id="container">
        <div id="profile">
            <div id="image">
                <img id="profile-photo" src="https://scontent.fsgn13-3.fna.fbcdn.net/v/t39.30808-6/364771634_815978610109926_4752215230612275701_n.jpg?_nc_cat=108&ccb=1-7&_nc_sid=09cbfe&_nc_ohc=ARhYtZRU3eoAX_nTuxy&_nc_ht=scontent.fsgn13-3.fna&oh=00_AfCC8cEIdOtO_rvFGa9SAnjEjwKNIdmGmJI-6MH7574FrQ&oe=64D0C334" alt="Profile-Image">
                <a href="#"><i class="fas fa-pen stroke-transparent"></i></a>
            </div>
            <p id="name">${this.model.get("name")}<br><span id="email">${this.model.get("email")}</span></p>
            <p id="designation">Kĩ sư lập trình Website<br><span id="college">Font-End</span></p>
            ...
            <hr width="100%">
            <div id="about">
                <p style="display:inline;">Về</p>
                <a href="#"><i class="fas fa-pen stroke-transparent-blue"></i></a>
            </div>
            <p id="year-graduation">Dự kiến năm tốt nghiệp<br><strong>Tháng 6/2024</strong></p>
            <p id="education">Học vấn<br><strong>Cao đẳng FPT Polytechnic</strong><br>Ngành lập trình Website</p>
            <p id="more-about">Các kỹ năng<br><span><strong>Ngôn ngữ lập trình</strong><br> ( Java, JavaScript, PHP )
                     </span><br><span><strong>Công cụ văn phòng</strong><br>(Word, Excel, PowerPoint)</span>
            </p>
            <p id="telephone">Telephone<br><strong>${this.model.get("phone")}</strong></p>
        </div>
        <div id="info-cards">
            <!-- <div class="card">
            ...
            <div class="card">
                <p><i class="fas fa-briefcase stroke-transparent"></i>&nbsp;&nbsp;&nbsp;Dự án cá nhân</p>
                <ul>
                    <li>
                    ...
                    <!-- <li>
                        <p class="tags">TodoMVC<br><span>Ứng dụng web đơn giản cho phép người dùng quản lý danh sách
                                công việc của họ. Nó được xây dựng bằng HTML, CSS và JavaScript và có sẵn trong nhiều
                                ngôn ngữ lập trình khác nhau. | <span>2022</span></span></p>
                        <a class="edit" href="#"><i class="fas fa-pen stroke-transparent-blue"></i></a>
                    </li>
                    <li>
                        <p class="tags">Microsoft Research India 2012 Summer School on Distributed Algorithms, Systems
                            and Programming<br><span>IISc Bangalore | <span>2012</span></span></p>
                        <a class="edit" href="#"><i class="fas fa-pen stroke-transparent-blue"></i></a>
                    </li>
                    <li>
                        <p class="tags">IEEE workshop on Cyber security<br><span>DAIICT Gandhi Nagar | <span>Nov,
                                    2013</span></span></p>
                        <a class="edit" href="#"><i class="fas fa-pen stroke-transparent-blue"></i></a>
                    </li>
                    <li>
                        <p class="tags">Author workshop jointly organized by Central Library<br><span>MNNIT Allahabad &
                                Springer (India) Pvt. Ltd New Delhi | <span>29th October, 2015</span></span></p>
                        <a class="edit" href="#"><i class="fas fa-pen stroke-transparent-blue"></i></a>
                    </li>
                    <li>
                        <p class="tags">Workshop for Computer Science Teachers<br><span>IIT Kanpur | <span>July,
                                    2014</span></span></p>
                        <a class="edit" href="#"><i class="fas fa-pen stroke-transparent-blue"></i></a>
                    </li>
                    <li>
                        <p class="tags">15th International Conference on Cryptology INDOCRYPT<br><span> |
            ...
            <div class="card">
                <p><i class="fas fa-graduation-cap stroke-transparent"></i>&nbsp;&nbsp;&nbsp;Kĩ năng cá nhân</p>
                <ul>
                    <li>
                        <p class="tags">TodoMVC<br><span>Ứng dụng web đơn giản cho phép người dùng quản lý danh sách
                                công
                                việc của họ. Nó được xây dựng bằng HTML, CSS và JavaScript và có sẵn trong nhiều ngôn
                                ngữ lập
                                trình khác nhau.</span></p>
                        <a class="edit" href="#"><i class="fas fa-pen stroke-transparent-blue"></i></a>
                    </li>
                    <li>
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Attributes", ()=>Attributes) // Lớp Attributes có khả năng làm việc với một loạt các đối tượng có kiểu T khác nhau, 
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gXSLD":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class UserForm extends (0, _view.View) {
    ...
    template() {
      ...
      <div>
        ...
        <div>Email: ${this.model.get("email")}</div>
        <div>Phone: ${this.model.get("phone")}</div>
        <input />
        <button class="set-name">Change Name</button>
        <input id="input2"/>
        <button class="set-age">Set Age</button>
        <input id="input3"/>
        <button class="set-email">Set Email</button>
        <input id="input4"/>
        <button class="set-phone">Set phone</button>
...
},{"./View":"5Vo78","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3CihC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./View":"5Vo78","./UserForm":"gXSLD","./UserShow":"2Tlyi","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["2oZg2","h7u1C"], "h7u1C", "parcelRequire94c2")

//# sourceMappingURL=index1.b71e74eb.js.map
